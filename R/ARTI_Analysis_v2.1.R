ARTI_Analysis_v2.1 <- function(track.history="Y",track.count="Y",track.heading="Y",track.speed="Y",track.altitude="Y",antenna.angle="Y",interval=3600,zoom=12,map.type="terrain"){
            ...
            #Graph it!
              for(x in 1:how.many.graphs){
                ...
                #Make a title for your graphic
                  graph.title<-paste0(site.name," Track History \nLocal Timezone: ",local.time.zone)
